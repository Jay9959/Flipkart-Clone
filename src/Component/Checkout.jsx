    ...
    return (
        <section className="py-5">
            <Container className="text-light">
                <h1 className="text-center bg-body-secondary mb-4 py-1 rounded text-secondary">
                    Your Order: {data.length}
                </h1>

                <Table striped bordered hover responsive className="bg-info-subtle">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>IMG</th>
                ...
                {orderPlaced ? (
                    ...
                    data.length > 0 && (
                        <Form onSubmit={handleOrder} className="bg-success-subtle text-dark p-4 rounded">
