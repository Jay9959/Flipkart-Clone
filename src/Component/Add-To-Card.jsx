                ...
                <Table striped bordered hover responsive>
                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        {user ? (
                                            ...
                                            <Button variant="warning" onClick={() => navigate("/login")}>Login to Remove</Button>
                                        )}
                                    </td>
                                </tr>
                            ))
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>
                                {user ? (
                                    <Button variant="primary" onClick={handleOrder}>Go to Checkout </Button>
                                ) : (
                                    <Button variant="secondary" onClick={() => navigate("/login")}>Login to Order</Button>
                                )}
                            </td>
                        </tr>
                    </tfoot>
