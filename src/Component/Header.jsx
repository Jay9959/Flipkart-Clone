                ...
                <Navbar expand="md">
                    ...
                    <Navbar.Collapse id="navbar-nav" className="m-4">
                        <Form className="d-flex mx-auto my-2 my-md-0 w-50" onSubmit={handleSearchSubmit}>
                            <div className="position-relative w-100">
                                <Form.Control
                                    ...
                                    className="form-control text-dark ps-4 rounded"
                                    value={searchTerm}
                        ...
                        <Nav className="ms-auto d-flex align-items-center gap-3">
                            ...
                            {user ? (
                                <Button variant="primary" className="d-flex align-items-center" onClick={signOut}>
                                    <FiUser className="me-1" /> Logout
                                </Button>
                            ) : (
                                <Button variant="primary" className="d-flex align-items-center" onClick={() => navigate("/login")}>
